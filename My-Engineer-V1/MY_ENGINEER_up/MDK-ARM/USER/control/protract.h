...
#define PROTRACT_MINI_OK 						(distance(protract.base_info.measure_angle,PROTRACT_MIN)<300 && m_abs(protract.base_info.measure_speed <10))
#define PROTRACT_MID_OK 						(distance(protract.base_info.measure_angle,PROTRACT_MID)<300 && m_abs(protract.base_info.measure_speed <10))
