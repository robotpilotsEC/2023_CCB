...
#define UPLIFT_INTERFERE					(140000)
#define UPLIFT_ONE_ORE						(100000)
...
#define ONE_UPLIFT_IS_OK 					(distance(uplift.measure_angle,UPLIFT_ONE_ORE)<600 && uplift.measure_speed == 0)
#define TWO_UPLIFT_IS_OK 					(distance(uplift.measure_angle,UPLIFT_TWO_ORE)<600 && uplift.measure_speed == 0)
#define THREE_UPLIFT_IS_OK 				(distance(uplift.measure_angle,UPLIFT_THREE_ORE)<600 && uplift.measure_speed == 0)
